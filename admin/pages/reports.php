          ...
          WHERE r.status = 'approved'";
                ...
                ?>
                  ...
                  <td>
                    ...
                    <a class="dropdown-item delete" href="deleting.php?action=delete&table=reports&item=<?php echo $report_row; ?>&page=<?php echo $current_page; ?>"><i class="bx bx-trash me-1"></i> Delete</a>
                    </div>
                    </div>
                  </td>
                  </tr>
